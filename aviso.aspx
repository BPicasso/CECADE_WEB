<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="aviso.aspx.cs" Inherits="CECADE.aviso" %>
  ...
  <div id="topbar" class="fixed-top d-flex align-items-center ">
    <div class="container d-flex align-items-center justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center" style="color:white;">
        <i style="color: #d70067;" class="bi bi-envelope-fill"></i><a href="mailto:contact@example.com" style="color:white;">cecade@chihuahua.gob.mx</a>
  ...
  <header id="header" class="fixed-top d-flex align-items-center ">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="aviso.aspx" style="color: white; font-weight:normal;">Marco Legal</a></li>
        </ul>
