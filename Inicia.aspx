    ...
    <div class="frame">
        ...
        <div ng-app ng-init="checked = false">
            <form class="form-signin" action="" method="post" name="form">
              <label for="username">Nombre de usuario</label> <input class="form-styling" type="text" name="username" placeholder="" /> 
              <label for="password" >Contrase&ntilde;a</label> <input class="form-styling" type="password" name="password" placeholder="" /> 
              <a href="menu.aspx" style="border-radius: 0px 35px 0px 35px; height: 35px; width: 110%; color: white; background: #e50069; font-size: 15px;" class="btn-signin">Iniciar Sesi&oacute;n</a> </form>
            </form>
            <form class="form-signup" action="" method="post" name="form"> 
              <label for="fullname">Nombre Completo</label> <input class="form-styling" type="text" name="fullname" placeholder="" /> 
              <label for="email">Correo electr&oacute;nico</label> <input class="form-styling" type="text" name="email" placeholder="" /> 
              <label for="password">Contrase&ntilde;a</label> <input class="form-styling" type="password" name="password" placeholder="" /> 
              <label for="confirmpassword">Confirmar contrase&ntilde;a</label> <input class="form-styling" type="password" name="confirmpassword" placeholder="" />
                <a href="inicia.aspx" style="border-radius: 0px 35px 0px 35px; height: 35px; width: 110%; color: white; background: #e50069; font-size: 15px;" class="btn-signup">Registrarme</a> </form>
